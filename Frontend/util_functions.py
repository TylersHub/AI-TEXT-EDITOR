...
# Name Regex: Requires 2+ characters, allows letters and (non-continuous) hyphens
...
def validate_name(name_input_text: str) -> tuple[bool, str]:
    if name_input_text == "" or name_input_text.isspace():
        return (False, "EMPTY")
    elif not NAME_REGEX.match(name_input_text):
