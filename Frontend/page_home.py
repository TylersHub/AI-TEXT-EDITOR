...
from Frontend.util_widgets import Page, SideBar, TopBar, PrimaryButton, FilePreview
...
class HomePage(Page):
    ...
    def __init_file_previews(self):
        ...
        for file_prev in file_prevs:
            ...
            file_pr.edit_file_label.clicked.connect(lambda _, fpi=file_prev["id"]: self.navigate_to_file_edit.emit(fpi, "self"))
